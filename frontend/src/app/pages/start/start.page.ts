...
import { TECHNICAL_DIAGRAMS, TECHNICAL_SECTIONS, type TechnicalDiagram, type TechnicalSection } from '@app/_data/technical-manual.data';
import { AuthService } from '@services/auth.service';

@Component({
  selector: 'app-start',
  imports: [CommonModule, FormsModule, CardModule, ButtonModule, InputTextModule, RouterLink, HelpManualComponent],
  template: `
    <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-surface-900 dark:to-surface-800 py-12 px-4">
      <div class="max-w-6xl mx-auto">
        ...
        <!-- Manual Section -->
        <div class="bg-white dark:bg-surface-900 rounded-2xl shadow-sm border border-gray-200 dark:border-surface-700 p-8 lg:p-10">
          <div class="flex flex-wrap items-center justify-between gap-4 mb-4">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-surface-50">Planner Tool Manual</h2>
            <app-help-manual
        ...
        >
          <div class="flex flex-wrap items-center justify-between gap-4 mb-4">
            <div>
              <h2 class="text-2xl font-bold text-gray-900 dark:text-surface-50">Technical Manual</h2>
          ...
          <div *ngIf="filteredTechnicalDiagrams.length > 0" class="mb-6">
            <div class="text-xs font-semibold uppercase tracking-wide text-gray-500 mb-2">Diagrams</div>
              ...
              >
                ...
                <ng-container [ngSwitch]="diagram.id">
                  ...
                  >
                    <defs>
                      <marker id="arrow" markerWidth="10" markerHeight="8" refX="9" refY="4" orient="auto">
                        <path d="M0,0 L10,4 L0,8 Z" fill="#4b5563"></path>
                      </marker>
                    </defs>
                    <rect x="10" y="30" width="130" height="50" rx="8" fill="#ffffff" stroke="#94a3b8"></rect>
                    <text x="75" y="60" text-anchor="middle" font-size="12" fill="#111827">Map UI</text>

                    <rect x="170" y="30" width="160" height="50" rx="8" fill="#ffffff" stroke="#94a3b8"></rect>
                    <text x="250" y="55" text-anchor="middle" font-size="12" fill="#111827">AutoRoutes</text>
                    <text x="250" y="70" text-anchor="middle" font-size="10" fill="#6b7280">Controller</text>

                    <rect x="360" y="30" width="200" height="50" rx="8" fill="#ffffff" stroke="#94a3b8"></rect>
                    <text x="460" y="55" text-anchor="middle" font-size="12" fill="#111827">Planning Services</text>
                    <text x="460" y="70" text-anchor="middle" font-size="10" fill="#6b7280">Routing, weights</text>

                    <rect x="590" y="30" width="180" height="50" rx="8" fill="#ffffff" stroke="#94a3b8"></rect>
                    <text x="680" y="55" text-anchor="middle" font-size="12" fill="#111827">EF Core</text>
                    <text x="680" y="70" text-anchor="middle" font-size="10" fill="#6b7280">SQL Server</text>

                    <line x1="140" y1="55" x2="170" y2="55" stroke="#4b5563" stroke-width="2" marker-end="url(#arrow)"></line>
                    <line x1="330" y1="55" x2="360" y2="55" stroke="#4b5563" stroke-width="2" marker-end="url(#arrow)"></line>
                    <line x1="560" y1="55" x2="590" y2="55" stroke="#4b5563" stroke-width="2" marker-end="url(#arrow)"></line>
                  </svg>
                  ...
                  >
                    ...
                    <rect x="20" y="20" width="150" height="50" rx="8" fill="#ffffff" stroke="#94a3b8"></rect>
                    <text x="95" y="50" text-anchor="middle" font-size="12" fill="#111827">Drivers</text>

                    <rect x="230" y="20" width="150" height="50" rx="8" fill="#ffffff" stroke="#94a3b8"></rect>
                    <text x="305" y="50" text-anchor="middle" font-size="12" fill="#111827">Routes</text>

                    <rect x="440" y="20" width="170" height="50" rx="8" fill="#ffffff" stroke="#94a3b8"></rect>
                    <text x="525" y="50" text-anchor="middle" font-size="12" fill="#111827">ServiceLocations</text>

                    <rect x="230" y="110" width="150" height="50" rx="8" fill="#ffffff" stroke="#94a3b8"></rect>
                    <text x="305" y="140" text-anchor="middle" font-size="12" fill="#111827">RouteStops</text>

                    <rect x="20" y="110" width="170" height="50" rx="8" fill="#ffffff" stroke="#94a3b8"></rect>
                    <text x="105" y="140" text-anchor="middle" font-size="12" fill="#111827">RouteMessages</text>

                    <rect x="440" y="110" width="220" height="50" rx="8" fill="#ffffff" stroke="#94a3b8"></rect>
                    <text x="550" y="140" text-anchor="middle" font-size="12" fill="#111827">RouteChangeNotifications</text>

                    <line x1="170" y1="45" x2="230" y2="45" stroke="#4b5563" stroke-width="2" marker-end="url(#arrow2)"></line>
                    <line x1="305" y1="70" x2="305" y2="110" stroke="#4b5563" stroke-width="2" marker-end="url(#arrow2)"></line>
                    <line x1="380" y1="45" x2="440" y2="45" stroke="#4b5563" stroke-width="2" marker-end="url(#arrow2)"></line>
                    <line x1="230" y1="135" x2="190" y2="135" stroke="#4b5563" stroke-width="2" marker-end="url(#arrow2)"></line>
                    <line x1="380" y1="135" x2="440" y2="135" stroke="#4b5563" stroke-width="2" marker-end="url(#arrow2)"></line>
                  </svg>
                  ...
                  >
                    ...
                    <rect x="30" y="30" width="200" height="50" rx="8" fill="#ffffff" stroke="#94a3b8"></rect>
                    <text x="130" y="55" text-anchor="middle" font-size="12" fill="#111827">TravelTimeRegions</text>

                    <rect x="280" y="20" width="210" height="50" rx="8" fill="#ffffff" stroke="#94a3b8"></rect>
                    <text x="385" y="45" text-anchor="middle" font-size="12" fill="#111827">RegionSpeedProfiles</text>

                    <rect x="280" y="95" width="210" height="50" rx="8" fill="#ffffff" stroke="#94a3b8"></rect>
                    <text x="385" y="120" text-anchor="middle" font-size="12" fill="#111827">LearnedTravelStats</text>

                    <rect x="540" y="58" width="200" height="50" rx="8" fill="#ffffff" stroke="#94a3b8"></rect>
                    <text x="640" y="83" text-anchor="middle" font-size="12" fill="#111827">TravelTimeModel</text>

                    <line x1="230" y1="55" x2="280" y2="45" stroke="#4b5563" stroke-width="2" marker-end="url(#arrow3)"></line>
                    <line x1="230" y1="55" x2="280" y2="120" stroke="#4b5563" stroke-width="2" marker-end="url(#arrow3)"></line>
                    <line x1="490" y1="70" x2="540" y2="83" stroke="#4b5563" stroke-width="2" marker-end="url(#arrow3)"></line>
                    <line x1="490" y1="120" x2="540" y2="108" stroke="#4b5563" stroke-width="2" marker-end="url(#arrow3)"></line>
                  </svg>
                </ng-container>
              </div>
            </div>
          ...
          <div *ngIf="filteredTechnicalSections.length > 0; else technicalEmpty">
            <div
              *ngFor="let section of filteredTechnicalSections"
              class="mb-6 border-b border-gray-200 pb-4 last:border-b-0 last:pb-0"
            >
              <h3 class="text-lg font-semibold text-gray-900 dark:text-surface-50">{{ section.title }}</h3>
              <p class="text-sm text-gray-600 dark:text-surface-300 mb-2">{{ section.summary }}</p>

              <div *ngIf="section.businessLogic.length > 0" class="mb-3">
                <div class="text-xs font-semibold uppercase tracking-wide text-gray-500 mb-1">Business logic</div>
                <ul class="list-disc pl-5 text-sm text-gray-700 dark:text-surface-200 space-y-1">
                  <li *ngFor="let item of section.businessLogic">{{ item }}</li>
                </ul>
              </div>

              <div *ngIf="section.database.length > 0" class="mb-3">
                <div class="text-xs font-semibold uppercase tracking-wide text-gray-500 mb-1">Database</div>
                <ul class="list-disc pl-5 text-sm text-gray-700 dark:text-surface-200 space-y-1">
                  <li *ngFor="let item of section.database">{{ item }}</li>
                </ul>
              </div>

              <div *ngIf="section.api.length > 0" class="mb-3">
                <div class="text-xs font-semibold uppercase tracking-wide text-gray-500 mb-1">API</div>
                <ul class="list-disc pl-5 text-sm text-gray-700 dark:text-surface-200 space-y-1">
    ...
    return this.technicalSections
      .map((section) => {
        const matchesHeader =
          section.title.toLowerCase().includes(term) ||
          section.summary.toLowerCase().includes(term);
        const businessLogic = section.businessLogic.filter((item) => item.toLowerCase().includes(term));
        ...
        if (!matchesHeader && businessLogic.length === 0 && database.length === 0 && api.length === 0 && notes.length === 0) {
          return null;
        }

        return {
          ...section,
          businessLogic: businessLogic.length > 0 ? businessLogic : matchesHeader ? section.businessLogic : [],
