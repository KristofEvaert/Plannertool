                ...
                <div
                  ...
                  <div class="flex flex-wrap items-center justify-between gap-4 mb-4">
                    ...
                    <div class="mb-5">
                      ...
                      @if (filteredManualSections.length > 0) {
                        <div>
                          @for (section of filteredManualSections; track section) {
                            <div
                    ...
                    @if (isSuperAdmin()) {
                      <div
                        ...
                        <div class="mb-5">
                          ...
                          @if (filteredTechnicalDiagrams.length > 0) {
                            <div class="mb-6">
                              <div class="text-xs font-semibold uppercase tracking-wide text-gray-500 mb-2">
                                Diagrams
                              </div>
                              <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                @for (diagram of filteredTechnicalDiagrams; track diagram) {
                                  <div
                                                                        ...
                                                                        <line
                                                                          ...
                                                                          @case ('travel-model') {
                                                                            <svg
                                                                              ...
                                                                              @if (filteredTechnicalSections.length > 0) {
                                                                                <div>
                                                                                  @for (section of filteredTechnicalSections; track section) {
                                                                                    <div
                                                                                      class="mb-6 border-b border-gray-200 pb-4 last:border-b-0 last:pb-0"
                                                                                      >
                                                                                      <h3 class="text-lg font-semibold text-gray-900 dark:text-surface-50">
                                                                                      ...
                                                                                      <p class="text-sm text-gray-600 dark:text-surface-300 mb-2">{{ section.summary }}</p>
                                                                                      @if (section.businessLogic.length > 0) {
                                                                                        <div class="mb-3">
                                                                                          <div class="text-xs font-semibold uppercase tracking-wide text-gray-500 mb-1">
                                                                                            Business logic
                                                                                          </div>
                                                                                          <ul class="list-disc pl-5 text-sm text-gray-700 dark:text-surface-200 space-y-1">
                                                                                            @for (item of section.businessLogic; track item) {
                                                                                              <li>{{ item }}</li>
                                                                                            }
                                                                                          </ul>
                                                                                        </div>
                                                                                      }
                                                                                      @if (section.database.length > 0) {
                                                                                        <div class="mb-3">
                                                                                          <div class="text-xs font-semibold uppercase tracking-wide text-gray-500 mb-1">
                                                                                            Database
                                                                                          </div>
                                                                                          <ul class="list-disc pl-5 text-sm text-gray-700 dark:text-surface-200 space-y-1">
                                                                                            @for (item of section.database; track item) {
                                                                                              <li>{{ item }}</li>
                                                                                            }
                                                                                          </ul>
                                                                                        </div>
                                                                                      }
                                                                                      @if (section.api.length > 0) {
                                                                                        <div class="mb-3">
                                                                                          <div class="text-xs font-semibold uppercase tracking-wide text-gray-500 mb-1">
                                                                                            API
                                                                                          </div>
                                                                                          <ul class="list-disc pl-5 text-sm text-gray-700 dark:text-surface-200 space-y-1">
                                                                                            @for (item of section.api; track item) {
                                                                                              <li>{{ item }}</li>
                                                                                            }
                                                                                          </ul>
                                                                                        </div>
                                                                                      ...
                                                                                      @if (section.notes.length > 0) {
                                                                                        <div>
                                                                                          ...
                                                                                          <ul class="list-disc pl-5 text-sm text-gray-700 dark:text-surface-200 space-y-1">
                                                                                            @for (item of section.notes; track item) {
                                                                                              <li>{{ item }}</li>
                                                                                            }
                                                                                          </ul>
                                                                                        </div>
