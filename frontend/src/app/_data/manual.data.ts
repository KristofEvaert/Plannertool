...
export const MANUAL_SECTIONS: ManualSection[] = [
  ...
  },
  {
    ...
    functions: [
      ...
      'Planners and admins can create or adjust weight templates from the map.',
    ],
    options: [
      'Select the active day for driver routes.',
      'Service type options follow the selected owner.',
      'Choose a weight template before auto-generate (algorithm + due date priority + worktime deviation).',
  ...
  },
  {
    ...
    summary: 'Create owner-scoped templates that define the algorithm and settings.',
    functions: [
      'Create, edit, and delete templates (admin only).',
      'Adjust algorithm, due date priority, and worktime deviation.',
    ],
    options: [
      'Owner filter is available for SuperAdmin.',
      'Templates are owner-only (no service type scope).',
    ],
  },
  {
    id: 'cost-settings',
